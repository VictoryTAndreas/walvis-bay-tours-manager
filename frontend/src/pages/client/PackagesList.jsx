  ...
  return (
    <div className="client-packages-page">
      ...
      <section className="hero-section">
        ...
        <img src={heroImages[currentHeroIndex]} alt={`Hero ${currentHeroIndex + 1}`} />
          ...
          {filteredPackages.map(pkg => (
            <div key={pkg.packageID} className="package-card">
                  ...
                  <div className="price-container">
                    {pkg.offer < pkg.price ? (
                      <>
                        ...
                        <span className="offer-price">N${pkg.offer}</span>
                      </>
                    ) : (
                      <span className="offer-price">N${pkg.price}</span>
                    )}
              ...
              <div className="tw-mt-8 tw-flex tw-gap-4">
                <button
                  onClick={() => navigate('/payment?packageId=' + pkg.packageID)}
                  className={`tw-flex-1 tw-font-semibold tw-py-3 tw-px-6 tw-rounded-lg tw-transition-colors tw-duration-200 ${
                    pkg.available !== undefined && pkg.available <= 0
